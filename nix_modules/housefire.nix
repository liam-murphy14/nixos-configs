...
let
  ...
  housefireTimerFactory = { ticker, dayOfMonth }: {
...

{
  ...
  systemd.timers."housefire-pld" = housefireTimerFactory { ticker = "pld"; dayOfMonth = "01"; };
  systemd.services."housefire-dlr" = housefireServiceFactory { ticker = "dlr"; };
  systemd.timers."housefire-dlr" = housefireTimerFactory { ticker = "dlr"; dayOfMonth = "03"; };
  systemd.services."housefire-eqix" = housefireServiceFactory { ticker = "eqix"; };
  systemd.timers."housefire-eqix" = housefireTimerFactory { ticker = "eqix"; dayOfMonth = "07"; };
  systemd.services."housefire-spg" = housefireServiceFactory { ticker = "spg"; };
  systemd.timers."housefire-spg" = housefireTimerFactory { ticker = "spg"; dayOfMonth = "11"; };
  systemd.services."housefire-well" = housefireServiceFactory { ticker = "well"; };
  systemd.timers."housefire-well" = housefireTimerFactory { ticker = "well"; dayOfMonth = "15"; };
}
